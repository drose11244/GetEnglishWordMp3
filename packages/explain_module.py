...
def get_explain(word):
    ...
    try:
        ...
        response = requests.get(
            dict_url, headers=cookieAndheaders.headers, cookies=cookieAndheaders.cookies)
        ...
        # get part of speech
        get_part_of_speech_amount = getResult.find_all(
            'div', class_='pr entry-body__el')
        ...
        for position_part_of_speech in range(0, len_part_od_speech):
            ...
            get_part_of_speech_text = get_part_Of_speech[position_part_of_speech] \
                .text.strip()
            ...
            for explain in range(0, let_explain):
                ...
                for Position_explain_in_Mandarin in range(0, len_get_explain_Mandarin):
                    ...
                    get_example_English = get_explain[explain].find_all(
                        'span', class_='eg deg')
                    get_example_Mandarin = get_explain[explain].find_all(
                        'span', class_='trans dtrans dtrans-se hdb')
        ...
        print("get_explain_Unexpected error:", sys.exc_info()[0])
